...
export default function DocsMapPage() {
    ...
    <div className="mx-auto max-w-3xl pb-16">
      <header className="mb-6">
        ...
        <h1 className="mt-1 font-display text-2xl font-semibold text-fg sm:text-3xl">
          react.dev / nextjs.org 对照
        </h1>
        <p className="mt-2 text-sm leading-relaxed text-muted">
          官方提供{" "}
          <a
            href="https://react.dev/llms.txt"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            ...
            className="text-primary no-underline hover:underline"
          >
            nextjs.org/docs/llms.txt
          </a>
          。本站另发布{" "}
          <a href="/llms.txt" className="text-primary no-underline hover:underline">
            llms.txt
          </a>{" "}
          /{" "}
          <a href="/llms-full.txt" className="text-primary no-underline hover:underline">
            llms-full.txt
          </a>
          。更全链接见{" "}
          <Link href="/official" className="text-primary no-underline hover:underline">
            官方中枢
          </Link>
          。
        </p>
        <div className="mt-4 flex flex-wrap items-center gap-3">
          <div className="h-2 min-w-[8rem] flex-1 overflow-hidden rounded-full bg-surface-3 sm:max-w-xs">
            <div className="h-full rounded-full bg-primary" style={{ width: `${cov.pct}%` }} />
          </div>
